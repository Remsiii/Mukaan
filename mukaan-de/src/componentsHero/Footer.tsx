    ...
    <footer className="bg-gray-900 py-12 px-4 border-t border-gray-800">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-2">Deine Quelle für die besten Tech-Deals und Tipps</p>
        </div>
        <div>
          <h3 className="text-lg font-semibold mb-4 text-purple-400">Schnelllinks</h3>
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/tipps" className="text-gray-400 hover:text-purple-400 transition-colors">
                Tipps
              </Link>
            </li>
            <li>
              <Link href="/ueber-uns" className="text-gray-400 hover:text-purple-400 transition-colors">
                Über uns
              </Link>
            </li>
          </ul>
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4 text-purple-400">Rechtliches</h3>
          <ul className="space-y-2">
            <li>
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4 text-purple-400">Folge uns</h3>
      ...
      <div className="container mx-auto mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
        <p>&copy; 2023 TechDealsHub. Alle Rechte vorbehalten.</p>
      </div>
    </footer>
  )
}
